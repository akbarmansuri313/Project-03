<%@page import="in.co.rays.project_3.dto.DescriptionDTO"%>
<%@page import="java.util.Iterator"%>
<%@page import="java.util.List"%>
<%@page import="in.co.rays.project_3.controller.DescriptionListCtl"%>
...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.DESCRIPTION_LIST_CTL%>"
			method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="departmentName"
						...
						value="<%=ServletUtility.getParameter("departmentName", request)%>">
				</div>

				<div class="col-sm-2">
					<input type="text" name="departmentHead"
						placeholder="Enter Department Head" class="form-control"
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Department Name</th>
							<th width="20%" class="text">Department Head</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=dto.getDepartmentName()%></td>
							<td class="text"><%=dto.getDepartmentHead()%></td>
							<td class="text"><%=dto.getLocation()%></td>
							<td class="text"><%=dto.getStatus()%></td>
							<td class="text"><a
								href="DescriptionCtl?id=<%=dto.getId()%>">Edit</a></td>
						</tr>
						<%
							}
						%>
			...
			<table width="100%">
				<tr>
					<td><input type="submit" name="operation"
						...
						value="<%=DescriptionListCtl.OP_PREVIOUS%>"
						<%=pageNo > 1 ? "" : "disabled"%>></td>

					<td><input type="submit" name="operation"
						class="btn btn-primary btn-md"
						value="<%=DescriptionListCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md"
						value="<%=DescriptionListCtl.OP_DELETE%>"></td>

					<td align="right"><input type="submit" name="operation"
						class="btn btn-warning btn-md"
						value="<%=DescriptionListCtl.OP_NEXT%>"
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					value="<%=DescriptionListCtl.OP_BACK%>">
			</div>
