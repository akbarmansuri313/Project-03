...
public class EmployeeListCtl extends BaseCtl {
	...
	protected void preload(HttpServletRequest request) {
		...
		log.debug("EmployeeListCtl preload method started");
		...
		try {
			...
			log.error("Error in EmployeeListCtl preload", e);
		}

		log.debug("EmployeeListCtl preload method ended");
	}
	...
	protected BaseDTO populateDTO(HttpServletRequest request) {
		...
		log.debug("EmployeeListCtl populateDTO method started");
		...
		log.debug("EmployeeListCtl populateDTO method ended");
		return dto;
	}
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("EmployeeListCtl doGet method started");
		...
		log.debug("EmployeeListCtl doGet method ended");
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response)
		...
		log.debug("EmployeeListCtl doPost method started");
		...
		log.debug("EmployeeListCtl doPost method ended");
	}
	...
	protected String getView() {
		...
		log.debug("EmployeeListCtl getView method called");
