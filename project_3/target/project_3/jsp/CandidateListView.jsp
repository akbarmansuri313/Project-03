...
<body class="hm">
	...
	<div>
		<form class="pb-5" action="<%=ORSView.CANDIDATE_LIST_CTL%>"
			method="post">
			...
			<div class="row">
				...
				<div class="col-sm-2">
					<input type="text" name="candidateName"
						placeholder="Enter Candidate Name" class="form-control"
						value="<%=ServletUtility.getParameter("candidateName", request)%>">
				</div>

				<div class="col-sm-3">
					<input type="submit" class="btn btn-primary btn-md"
						name="operation" value="<%=CandidateListCtl.OP_SEARCH%>">
				...
				<table class="table table-bordered table-dark table-hover">
					<thead>
						<tr style="background-color: #8C8C8C;">
							...
							<th width="20%" class="text">Candidate Code</th>
							<th width="20%" class="text">Candidate Name</th>
							<th width="20%" class="text">Email</th>
							<th width="15%" class="text">Skill Set</th>
					...
					<tbody>
						...
						<tr>
							...
							<td class="text"><%=dto.getCandidateCode()%></td>
							<td class="text"><%=dto.getCandidateName()%></td>
							<td class="text"><%=dto.getEmail()%></td>
							<td class="text"><%=dto.getSkillSet()%></td>
							<td class="text"><a href="CandidateCtl?id=<%=dto.getId()%>">Edit</a>
							</td>
						</tr>
						<%
							}
			...
			<table width="100%">
				<tr>
					...
					<td><input type="submit" name="operation"
						...
						value="<%=CandidateListCtl.OP_NEW%>"></td>

					<td><input type="submit" name="operation"
						class="btn btn-danger btn-md"
						value="<%=CandidateListCtl.OP_DELETE%>"></td>
			...
			<div style="padding-left: 48%;">
				<input type="submit" name="operation" class="btn btn-primary btn-md"
					value="<%=CandidateListCtl.OP_BACK%>">
			</div>
